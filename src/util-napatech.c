...
static void *NapatechFlowInfoLoop(void *arg)
{
    ...
    flowinfo_counters.packets = StatsRegisterCounter("napa_bypass.pkts", tv);
    flowinfo_counters.bytes = StatsRegisterCounter("napa_bypass.bytes", tv);
    flowinfo_counters.to = StatsRegisterCounter("napa_bypass.to", tv);
    flowinfo_counters.fin = StatsRegisterCounter("napa_bypass.fin", tv);
